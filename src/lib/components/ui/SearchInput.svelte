...
<div
	class="flex h-9 items-center gap-2 rounded-xl border border-border {bgClass} px-3 transition-colors focus-within:border-border-hover focus-within:ring-2 focus-within:ring-ring"
>
	{#if isLoading}
